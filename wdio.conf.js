...
const screenshotPath = path.resolve("results", "screenshots");
...
//TODO: Need to work on mobile device spin function.
//
// function startMobileDevice() {
//   const device = process.env.DEVICETYPE;
//   if (device == "android") {
//     console.log("starting emulator");
//     shell.cd("/Users/pho/Library/Android/sdk/emulator");
//     shell.exec("./emulator -avd Pixel_2_API_28 -partition-size 512");
//   }
// }
